...
import com.naukma.hotelroomservice.hotel.HotelService;
...
public class RoomController {
    ...
    @GetMapping("/getByHotelAndNumber/{hotelAddress}/{roomNumber}")
    public ResponseEntity<Map<String, Object>> getClientByEmail(@PathVariable String hotelAddress,
